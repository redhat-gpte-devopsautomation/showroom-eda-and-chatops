...
.. Click on `Jobs` and observe latest executed job `X- push-favourable-feedback`.
+
.Automation Controller Jobs Page
image::04_controller_job-1.jpg[Automation_Controller,350]

.. Click on `X- push-favourable-feedback` to view and observe the logs.
+
.Automation Controller Jobs Details
image::04_controller_job-2.jpg[Automation_Controller,350]
